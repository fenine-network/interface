...
import { Currency, CurrencyAmount, Percent, Price, Token } from '@fenine/sdk-core'
...
export function useDerivedMintInfo(
  ...
  const price = useMemo(() => {
    if (noLiquidity) {
      ...
      return pair && wrappedCurrencyA ? (pair.priceOf(wrappedCurrencyA) as unknown as Price<Currency, Currency>) : undefined
    }
