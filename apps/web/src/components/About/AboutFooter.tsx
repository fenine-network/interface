...
const StyledLogo = styled(FenineMark)<{ isDarkMode: boolean }>`
  width: 72px;
  height: 72px;
  display: none;
  ${({ isDarkMode }) =>
...
const LogoSectionContent = () => {
  ...
  return (
    <>
      <StyledLogo aria-label="Fenine Logo" isDarkMode={isDarkMode} />
      <SocialLinks>
        ...
        >
          <SocialLink href="https://swap.fene.app" target="_blank" rel="noopener noreferrer">
            <TwitterIcon size={32} />
          </SocialLink>
        </TraceEvent>
        <SocialLink href="https://swap.fene.app" target="_blank" rel="noopener noreferrer">
      ...
      <Copyright>© {new Date().getFullYear()} Fenswap</Copyright>
    </>
  )
}
    ...
    <Footer>
      ...
      <FooterLinks>
        ...
        <LinkGroup>
          ...
          <ExternalTextLink href="https://swap.fene.app/ecosystem">Ecosystem</ExternalTextLink>
          <ExternalTextLink href="https://swap.fene.app/explorer">Explorer</ExternalTextLink>
          <ExternalTextLink href="https://swap.fene.app/docs">Developers</ExternalTextLink>
        </LinkGroup>
        <LinkGroup>
          ...
          >
            <ExternalTextLink href="https://swap.fene.app">Website</ExternalTextLink>
          </TraceEvent>
          <TraceEvent
            events={[BrowserEvent.onClick]}
            name={SharedEventName.ELEMENT_CLICKED}
          ...
          >
            <ExternalTextLink href="https://swap.fene.app/blog">Blog</ExternalTextLink>
          </TraceEvent>
        </LinkGroup>
        <LinkGroup>
          ...
          >
            <ExternalTextLink href="https://swap.fene.app/contact" target="_blank" rel="noopener noreferrer">
              Contact Us
            </ExternalTextLink>
          </TraceEvent>
          <TraceEvent
            ...
            element={InterfaceElementName.SUPPORT_LINK}
          >
            <ExternalTextLink href="https://swap.fene.app/help">Help Center</ExternalTextLink>
          </TraceEvent>
        </LinkGroup>
      </FooterLinks>
