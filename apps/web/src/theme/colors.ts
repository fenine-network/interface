...
export const colors = {
  ...
  neutral1_dark: '#FAF7E3',
  neutral2_dark: '#E0DCCB',
  neutral3_dark: '#B8B4A4',
  surface1_dark: '#3B3C3A',
  surface2_dark: '#434441',
  surface3_dark: '#FAF7E31F',
  surface4_dark: '#FAF7E336',
  surface5_dark: '#0000001A',
  accent1_dark: '#FAF7E3',
  accent2_dark: '#4A4B48',
  neutral1_light: '#3B3C3A',
  neutral2_light: '#5E5F5C',
  neutral3_light: '#8A8B86',
  surface1_light: '#F6F2DE',
  surface2_light: '#E7E3CE',
  surface3_light: '#3B3C3A1F',
  surface4_light: '#3B3C3A30',
  surface5_light: '#00000008',
  accent1_light: '#3B3C3A',
  accent2_light: '#E7E3CE',
  success: '#40B66B',
  critical: '#FF5F52',
...
const commonTheme = {
  ...
  brandedGradient: 'linear-gradient(139.57deg, #FAF7E3 4.35%, #E7E3CE 96.44%);',
